...
holiday2<- c("Lockdown1", "Lockdown2", "Lockdown3")
ds<-as.Date(c("2020-01-01","2020-10-01", "2021-01-01"))
lower_window<-c(0,0,0)
ds_upper<-as.Date(c("2020-07-10","2021-01-01", "2021-04-01"))
Lockdowns <- data.frame(holiday, ds, lower_window, ds_upper)
Lockdowns$upper_window<-(ds_upper-ds)
...
## Total surgical admissions to the 6 cardiac centres 
```{r, echo=FALSE, fig.height=4, fig.width=7}

#Total admissions from April 2012 to April 2022
cardiacsurgery_tsb %>%
summarise(TotalAdmit = sum(Admissions_1)) %>%  
ggplot(aes(x = Month, y =TotalAdmit)) + 
    geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", linewidth=1)+
  geom_line(color = "#2c2825", linewidth=1) +
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
   ...
   scale_y_continuous(expand = c(0, 0), limits=c(0,450, 200))



```

## Elective vs non-elective surgical admissions to the 6 cardiac centres
...
ggplot(aes(x = Month, y =TotalAdmit, group=Admit_Method)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.88))+
...
summarise(TotalAdmit = sum(Admissions_1)/n_distinct(adm_month)) %>%
...
cardiacsurgery%>%
  ...
  group_by(adm_year)%>%
summarise(Total = sum(Admissions_1)/n_distinct(adm_month)) %>%
ggplot(aes(x =  adm_year, y =Total)) + 
  geom_line(color="blue", size=1)  + 
  geom_point(color="blue", size=2)+
  labs( title = "Average monthly elective admissions by year",y = "Monthly number", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
...
## Total surgical procedures (elective and non-elective)

```{r, echo=FALSE, fig.height=6, fig.width=8}

summary_variables<-c("SurgicalAVR","Valve_Surgery" ,"AortoVascular_Surgery", "CABG")
...
PercentProceduretype<-cardiacsurgery %>%
    group_by(adm_year) %>%
  summarise(SurgicalAVR = sum(SurgicalAVR), Valve_Surgery=sum(Valve_Surgery), Aortovascular_Surgery=sum(AortoVascular_Surgery), CABG=sum(CABG), Total=sum(SurgicalAVR, Valve_Surgery, AortoVascular_Surgery, CABG)) %>% 
...
PercentProceduretype$Procedures<-factor(PercentProceduretype$Procedures, levels=c( "Aortovascular_Surgery",  "Valve_Surgery",  "SurgicalAVR", "CABG"))
...
NoProceduretype<-cardiacsurgery %>%
    group_by(adm_year) %>%
  summarise(SurgicalAVR = sum(SurgicalAVR)/n_distinct(adm_month), Valve_Surgery=sum(Valve_Surgery)/n_distinct(adm_month), Aortovascular_Surgery=sum(AortoVascular_Surgery)/n_distinct(adm_month), CABG=sum(CABG)/n_distinct(adm_month)) %>%
  gather(., "Procedures", "value", -adm_year) %>%
  mutate(adm_year=as.Date(adm_year))

NoProceduretype$Procedures<-factor(NoProceduretype$Procedures, levels=c( "Aortovascular_Surgery",  "Valve_Surgery",  "SurgicalAVR", "CABG"))
...
ggplot(NoProceduretype, aes(x=adm_year, y=value, fill=Procedures)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_blank(), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14),legend.position="bottom") +
  scale_y_continuous(expand = c(0, 0), limits=c(0,300, 0.2))+
  scale_x_continuous(breaks =c(2012,2014,2016, 2018, 2020, 2022))+
...
PercentProcedurebyProvider$Procedures<-factor(PercentProcedurebyProvider$Procedures, levels=c( "Aortovascular_Surgery",  "Valve_Surgery",  "SurgicalAVR", "CABG"))
...
ggplot(PercentProcedurebyProvider, aes(x=adm_year, y=value, fill=Procedures)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_blank(), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14),legend.position="bottom",
        strip.text = element_text(size = rel(1.1)),  strip.background = element_rect(fill = "White", colour="white", size = 1)) +
  scale_y_continuous(expand = c(0, 0), limits=c(0,101, 0.2))+
  scale_x_continuous(breaks =c(2012,2014,2016, 2018, 2020, 2022))+
 scale_fill_manual(values=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#b2b7b9", "#f9bf07")) 
...
## Surgical Admissions per hospital
...
ggplot(aes(x = Month, y =TotalAdmit)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits=c(0,120, 200)) 
...
ggplot(aes(x = Month, y =TotalAdmit, group=Admit_Method)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        strip.text = element_text(size = rel(1.1)),  strip.background = element_rect(fill = "White", colour="white", size = 1)) +           
  scale_color_manual(values=c("#2c2825", "#ec6555"))+          
 scale_y_continuous(expand = c(0, 0), limits=c(0,100, 200))
...
data_ends<- cardiacsurgery %>% 
  mutate(adm_year=as.character(adm_year)) %>%
  group_by (Der_Provider_Code, adm_year) %>%
 summarise(Average = (sum(epi_los_1)/sum(Episodes_1))) %>%
  mutate(Der_Provider_Code=recode(Der_Provider_Code,"RJE"="North Midlands","RKB"="Coventry & Warwickshire","RL4"="Wolverhampton", "RRK"="Birmingham","RWE"="Leicester", "RX1"="Nottingham"))%>%
  filter(adm_year==2022) 
...
#Total LOS between April 2012 to April 2022
 ...
 summarise(Average = (sum(epi_los_1)/sum(Episodes_1)))%>%
  ...
  geom_line(aes(color = Der_Provider_Code), size=1.2) +
  geom_point(aes(color = Der_Provider_Code), size=2.5) +
 geom_text_repel(aes( label = Der_Provider_Code), data=data_ends,  fontface = "bold",color=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"),
    size = 5,
    direction = "y",
    hjust = 0,
    nudge_x=5,
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_blank(), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= "bottom") +
       scale_y_continuous(expand = c(0, 0), limits=c(6,18, 200)) +
 scale_color_manual(values=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"), 
                    labels=c("North Midlands","Coventry & Warwickshire","Wolverhampton", "Birmingham", "Leicester", "Nottingham") ) 


 data_ends2<- cardiacsurgery %>% 
  mutate(adm_year=as.character(adm_year)) %>%
    group_by(adm_year,Der_Provider_Code ) %>%
    summarise(., Percent = (sum(weekend_disch_1)/sum(Admissions_1))*100)%>%
  mutate(Der_Provider_Code=recode(Der_Provider_Code,"RJE"="North Midlands","RKB"="Coventry & Warwickshire","RL4"="Wolverhampton", "RRK"="Birmingham","RWE"="Leicester", "RX1"="Nottingham"))%>%
  filter(adm_year==2022) 
...
cardiacsurgery%>%
 ...
 ggplot(aes(x =  adm_year , y =Percent, group=Der_Provider_Code), labeller=hospital_labeller) + 
  geom_line(aes(color = Der_Provider_Code), size=1.2) +
    geom_point(aes(color = Der_Provider_Code), size=2.5) +
   geom_text_repel(aes( label = Der_Provider_Code), data=data_ends2,  fontface = "bold",color=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"),
    size = 5,
    direction = "y",
    hjust = 0,
    nudge_x=5.1,
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_blank(), axis.title.y = element_text(size = 13.5,vjust=2),
 legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= "bottom") +
 scale_y_continuous(expand = c(0, 0), limits=c(14,30, 20)) +
 scale_color_manual(values=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"), 
                    labels=c("North Midlands","Coventry & Warwickshire","Wolverhampton", "Birmingham", "Leicester", "Nottingham") ) 


 data_ends3<- cardiacsurgery %>% 
    mutate(adm_year=as.character(adm_year)) %>%
    filter(Admit_Method=="Elective") %>%
    group_by(adm_year,Der_Provider_Code) %>%
    summarise(., Percent = (sum(DOSA_1)/sum(Admissions_1))*100)%>%
  mutate(Der_Provider_Code=recode(Der_Provider_Code,"RJE"="North Midlands","RKB"="Coventry & Warwickshire","RL4"="Wolverhampton", "RRK"="Birmingham","RWE"="Leicester", "RX1"="Nottingham"))%>%
  filter(adm_year==2022) 
...
# Day of surgery Admission (DOSA) by Provider
 ...
 ggplot(aes(x =  adm_year , y =Percent, group=Der_Provider_Code), labeller=hospital_labeller) + 
  geom_line(aes(color = Der_Provider_Code), size=1.2) +
    geom_point(aes(color = Der_Provider_Code), size=2.5) + 
     geom_text_repel(aes( label = Der_Provider_Code), data=data_ends3,  fontface = "bold",color=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"),
    size = 5,
    direction = "y",
    hjust = 0,
    nudge_x=5.1,
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_blank(), axis.title.y = element_text(size = 13.5,vjust=2),
   legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= "bottom") +
 scale_y_continuous(expand = c(0, 0), limits=c(0,32, 20))   +
 scale_color_manual(values=c("darkseagreen",  "#ff9933" , "#5881c1","#ec6555" ,"#343739", "#f9bf07"), 
                    labels=c("North Midlands","Coventry & Warwickshire","Wolverhampton", "Birmingham", "Leicester", "Nottingham") ) 
...
ggplot(aes(cardiacsurgery, x = adm_year, y =Percent)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_blank(), axis.title.y = element_text(size = 13.5,vjust=2))+          
 scale_y_continuous(expand = c(0, 0), limits=c(0,10, 20))
 ...
 # Emergency readmissions within 30 days
    cardiacsurgery%>%
      mutate(adm_year=as.Date(adm_year)) %>%
    group_by(adm_year) %>%
    summarise(., Total = (sum(Emerg_readm_surg_1)/sum(Admissions_1))*100)%>%
...
#Total LOS between April 2012 to April 2022
 cardiacsurgery_tsb %>%
 summarise(TotalLOS = sum(epi_los_1))%>%
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.8)) +
       scale_y_continuous(expand = c(0, 0), limits=c(0,5200, 200)) 
...
ggplot(aes(x = Month, y =TotalLOS, group=Admit_Method)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14),legend.position= c(0.15, 0.2)) +           scale_y_continuous(expand = c(0, 0), limits=c(0,3500, 5000)) +          
  scale_color_manual(values=c("#2c2825", "#ec6555"))
...
#Total LOS between April 2012 to April 2022
cardiacsurgery_tsb %>%
summarise(TotalLOS = sum(TotalCC_los_1)) %>%  
ggplot(aes(x = Month, y =TotalLOS)) + 
  geom_line(size=1) +
...
#Total LOS between April 2012 to April 2022
 ...
 summarise(Average = (sum(epi_los_1)/sum(Episodes_1)))%>%
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.8)) +
       scale_y_continuous(expand = c(0, 0), limits=c(0,15, 200)) 
...
ggplot(aes(x = Month, y =Average, group=Admit_Method)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits=c(0,15, 50)) +          
...
ggplot(aes(x = Month, y =Average, group=Admit_Method)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        ...
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2),
        legend.position="none", plot.title = element_text(size=14)) +           
  scale_y_continuous(expand = c(0, 0), limits=c(0,18, 50)) +          
...
Forecast_no_transform<-function(dataset, id_title, Label) {
   ...
   #Fit model
   m <- prophet( holidays=Lockdowns, changepoint.prior.scale = 0.1, changepoint_range=0.9,interval.width = 0.95 )
...
ElectiveAdmissionsQuarters <-filter(cardiacsurgery, Admit_Method=="Elective") %>%
  mutate(Quarter=quarter(Date, fiscal_start = 4, with_year=TRUE)) %>%
  group_by(Quarter)%>%
   summarise(., Total = sum(Admissions_1), Newdate=min(Date)) %>%
  mutate (., ds = Newdate, y = Total)%>%
...
# Attempting forecasting quarterly data to improve forecast accuracy
ElectiveAdmissionsQuarters$y =log(ElectiveAdmissionsQuarters$y)
  
   #Fit model
   m <- prophet( holidays2=Lockdowns,  changepoint.prior.scale = 0.1, changepoint_range=0.9,interval.width = 0.95 )
   #m<-add_country_holidays(m, country_name = 'GB')
   m<-fit.prophet(m, ElectiveAdmissionsQuarters) 
   #m$train.holiday.names
 ...
 plot(m, forecast) +add_changepoints_to_plot(m)
  ...
  inverse_forecast<-left_join(inverse_forecast, ElectiveAdmissionsQuarters , by="ds")
  inverse_forecast$ds<-as.Date(as.character(inverse_forecast$ds), format="%Y-%m-%d")
  ...
  inverse_forecast2$yhat_upper<-ifelse(!is.na(inverse_forecast2$Total), NA, inverse_forecast2$yhat_upper)
   ...
   ggplot() + 
    geom_line(inverse_forecast2, mapping=aes(x = ds, y= yhat), color="#5881c1", size=1) +
  geom_ribbon(inverse_forecast2,mapping= aes(x= ds, ymin = yhat_lower, ymax = yhat_upper), fill="#5881c1", alpha = 0.3) +
  labs( title = "Elective Admissions by quarter" ,y ="Number per quarter", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
...
Need to log to prevent values going negative
```{r, echo=FALSE, fig.height=4, fig.width=7}
...
Admissions<- Forecast_log_transform(Admissions, "Total Admissions", "Number")
...
## Total LOS
Need to log to prevent going into negative values
```{r, echo=FALSE, fig.height=4, fig.width=7}
...
LOS_Total<- Forecast_log_transform(LOS_Total, "Total LOS", "Days")
...
AverageElectiveLOS<-cardiacsurgery_tsb %>%
  filter(., Admit_Method=="Elective") %>%
summarise(MeanLOS = (sum(epi_los_1)/sum(Episodes_1))) 
...
MeanLOS_elective<- Forecast_log_transform(MeanLOS_elective, "Mean Elective LOS", "Days")
...
MeanLOS_non_elective<- Forecast_log_transform(MeanLOS_non_elective, "Mean Non-Elective LOS", "Days")
...
MeanLOS<- Forecast_log_transform(MeanLOS, "Mean Total LOS", "Days")
...
Need to log transform to stop negative values
```{r, echo=FALSE, fig.height=4, fig.width=7}
...
RJE<- Forecast_log_transform(RJE, "University Hospitals of North Midlands", "Number")
...
RKB<- Forecast_log_transform(RKB, "University Hospitals Coventry & Warwickshire", "Number")
...
RRK<- Forecast_log_transform(RRK, "University Hospitals Birmingham", "Number")
...
RWE<- Forecast_log_transform(RWE, "University Hospitals of Leicester", "Number")
...
CABG<- Forecast_log_transform(CABG, "Coronary Artery Bypass Graft", "Number")
...
#Total PCI
PCITAVI_tsb %>%
summarise(TotalPCI = sum(PCI)) %>%  
ggplot(aes(x = Month, y =TotalPCI)) + 
    geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", linewidth=1)+
  geom_line(color = "#2c2825", linewidth=1) +
  labs( title = "Total PCI Procedures",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.8))+
   scale_y_continuous(expand = c(0, 0), limits=c(0,1500, 200))


#Total TAVI
PCITAVI_tsb %>%
summarise(TotalTAVI = sum(TAVI)) %>%  
ggplot(aes(x = Month, y =TotalTAVI)) + 
    geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", linewidth=1)+
  geom_line(color = "#2c2825", linewidth=1) +
  labs( title = "Total TAVI Procedures",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.8))+
   scale_y_continuous(expand = c(0, 0), limits=c(0,150, 200))
...
#Elective and non-elective PCIs
PCITAVI_tsb %>%
    group_by(Admit_Method)%>%
summarise(TotalPCI = sum(PCI)) %>% 
ggplot(aes(x = Month, y =TotalPCI, group=Admit_Method)) + 
  geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", size=1)+
  geom_line(aes(color=Admit_Method), linewidth=1) +
  labs( title = "Elective vs Non-elective PCI Procedures",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.15, 0.15))+
  scale_color_manual(values=c("#2c2825", "#ec6555"))+
   scale_y_continuous(expand = c(0, 0), limits=c(0,1100, 200))

#Elective and non-elective TAVI
PCITAVI_tsb %>%
    group_by(Admit_Method)%>%
summarise(TotalTAVI = sum(TAVI)) %>% 
ggplot(aes(x = Month, y =TotalTAVI, group=Admit_Method)) + 
  geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", size=1)+
  geom_line(aes(color=Admit_Method), linewidth=1) +
  labs( title = "Elective vs Non-elective TAVI Procedures",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.15, 0.85))+
  scale_color_manual(values=c("#2c2825", "#ec6555"))+
   scale_y_continuous(expand = c(0, 0), limits=c(0,100, 200))
...
# Out of area patients having surgerical procedures in Midlands

```{r, echo=FALSE, fig.height=4, fig.width=7}
# Out of area patients having surgery in the midlands
OOAPatients<-cardiac %>%
  filter(Midlands_Centre==1 & Surgical==1 & mids_region==0) %>%
  dplyr::select(-Non_Midlands_Centre, -Midlands_Centre, -Surgical, -mids_region, -Der_Provider_Code, -Admit_Method) %>%
  group_by(adm_year, adm_month, Date)%>% 
  summarise(across(everything(), list(sum)), .groups='drop')%>%
  rename(TAVI=TAVI_1,  PCI=PCI_1 )


# Create tsibble
OOAPatients_tsb <-OOAPatients %>% 
  mutate(Month = yearmonth(Date))%>%
  as_tsibble(key=c(), index = Month)
...
ggplot(aes(x = Month, y =TotalAdmit)) + 
    geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", linewidth=1)+
  geom_line(color = "#2c2825", size=1) +
  labs( title = "Patients from outside the Midlands admitted to Midland Centres",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
        legend.text=element_text(size=12),legend.title=element_blank(),plot.title = element_text(size=14), legend.position= c(0.85, 0.8))+
   scale_y_continuous(expand = c(0, 0), limits=c(0,40, 200))

```

# Midlands residents going out of area for surgery

```{r, echo=FALSE, fig.height=4, fig.width=7}
# Out of area patients having surgery in the midlands
MidlandsPatients<-cardiac %>%
  filter(Midlands_Centre==0 & Surgical==1 & mids_region==1) %>%
  dplyr::select(-Non_Midlands_Centre, -Midlands_Centre, -Surgical, -mids_region, -Der_Provider_Code, -Admit_Method) %>%
  group_by(adm_year, adm_month, Date)%>% 
  summarise(across(everything(), list(sum)), .groups='drop')%>%
  rename(TAVI=TAVI_1,  PCI=PCI_1 )
...
# Create tsibble
MidlandsPatients_tsb <-MidlandsPatients %>% 
  mutate(Month = yearmonth(Date))%>%
  as_tsibble(key=c(), index = Month)


MidlandsPatients_tsb  %>%
summarise(TotalAdmit = sum(Admissions_1)) %>%  
ggplot(aes(x = Month, y =TotalAdmit)) + 
    geom_smooth(se=FALSE, col="#9d928a", linetype="dashed", linewidth=1)+
  geom_line(color = "#2c2825", size=1) +
  labs( title = "Midlands residents recieving cardiac surgery outside the Midlands",y = "Number per month", x="")+
  theme_bw()+
  theme(panel.grid.major.y = element_line(color = "grey80"), panel.grid.major.x =  element_blank(), panel.grid.minor.x =  element_blank(), panel.border = element_blank(), axis.line = element_line(colour = "black", size=1),
        axis.text.x = element_text(size = 12), axis.text.y = element_text(size = 12), 
        axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14,vjust=2), 
